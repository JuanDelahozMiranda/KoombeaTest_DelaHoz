...
public class homeConverter {
   ...
   public void pressAbsButton(AppiumDriver<MobileElement> driver){
    ...
    public void pressVelocidadOption(AppiumDriver<MobileElement> driver){
        MobileElement OpVelocidad = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.RelativeLayout/android.widget.ListView/android.widget.RelativeLayout[4]"));
            OpVelocidad.click();
    }
